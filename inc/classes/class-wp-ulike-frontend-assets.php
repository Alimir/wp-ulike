	...
	class wp_ulike_frontend_assets {
	  	...
	  	public function load_styles() {
	        ...
	        */
	        // @endif
	        // @if DEV
			wp_enqueue_style( 'wp-ulike', WP_ULIKE_ASSETS_URL . '/css/wp-ulike.css', array(), '3.5.0' );
	        // @endif
	     ...
	     */
	  	public function load_scripts() {
	        ...
	        */
	        ...
	        // @if DEV
			//Add wp_ulike script file with special functions.
			wp_enqueue_script( 'wp_ulike', WP_ULIKE_ASSETS_URL . '/js/wp-ulike.js', array( 'jquery' ), '3.5.0', true );
	        // @endif
